...
if info(1).BitDepth >8 %!%!%!%!
    answer = questdlg('Warning! The TIF file you are trying to load is more than 8bit! This can cause a wrong visualization! Please resample before loading. Proceed anyways?','Bit Depth too big!','No');
...
for ward = 1 : lenl,
    ...
    stack.M{1}(:,:,ward) = imread(fullfile(path,tname),'tif',ward);
%     if ward == 1,
