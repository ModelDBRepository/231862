...
if strfind (options, '-0')
    [tree,errtri] = elimt_tree (tree,'-0-e');        % eliminate trifurcations by adding short segments
else
    [tree,errtri] = elimt_tree (tree);        % eliminate trifurcations by adding short segments
end
